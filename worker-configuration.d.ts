/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 74bfa320c75bc9c7ee9c3582a43476a1)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		QR_SECRET: "fjasdfkajsdfksdfeuhfalds";
		EXTERNAL_API: string;
		APP_URL: string;
		ADMIN_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QR_SECRET" | "EXTERNAL_API" | "APP_URL" | "ADMIN_SECRET">> {}
}
