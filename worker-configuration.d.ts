/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4e5e6f0bb586d5facee4fbef8ff814ab)
// Runtime types generated with workerd@1.20260507.1 2026-05-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "lunarAttendance";
	}
	interface Env {
		...
		ASSETS: Fetcher;
		QR_SECRET: "replace-with-secret";
		ADMIN_SECRET: "supersecurepassword-";
		EXTERNAL_API: string;
		APP_URL: string;
		durable_objects_lunar_attendance: DurableObjectNamespace<import("./src/index").lunarAttendance>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QR_SECRET" | "ADMIN_SECRET" | "EXTERNAL_API" | "APP_URL">> {}
}
